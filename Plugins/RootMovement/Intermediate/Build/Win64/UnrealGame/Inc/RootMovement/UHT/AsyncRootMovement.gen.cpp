...
void FMovementEvent_DelegateWrapper(const FMulticastScriptDelegate& MovementEvent)
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SideScrollerProject_Plugins_RootMovement_Source_RootMovement_Public_AsyncRootMovement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAsyncRootMovement, UAsyncRootMovement::StaticClass, TEXT("UAsyncRootMovement"), &Z_Registration_Info_UClass_UAsyncRootMovement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAsyncRootMovement), 2459503490U) },
	};
